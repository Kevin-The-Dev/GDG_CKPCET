...
data.sort((a, b) => {
    ...
    return 0; // If all criteria are the same, maintain the order
        ...
        data.forEach((user, index) => {
            ...
            // Badge SVG for "Yes" Completion in blue color
            const badgeIcon = `
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#0076ff" class="bi bi-patch-check-fill ms-1" viewBox="0 0 16 16">
